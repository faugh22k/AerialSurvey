...
It then edits the data, combining the motion areas to make them more representative of
...
class Data:
    ...
    def createInformationString(self):
        ...
        call (any changes made to coordinates only affect the output string: no Blob will have its
        fields changed).
