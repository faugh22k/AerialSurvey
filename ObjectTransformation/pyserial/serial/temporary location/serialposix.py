...
#Kim import sys, os, fcntl, termios, struct, select, errno, time
import sys, os, termios, struct, select, errno, time
import fcntl 
from fcntl import *
...
class PosixSerial(SerialBase):
    ...
    def open(self):
        ...
        try:
            # Kim added
            #self.portstr = "/dev/tty.GarminGLO47d48-COM7"#"/dev/cu.GarminGLO47d48-COM7"# "COM7""COM5"
            #####
